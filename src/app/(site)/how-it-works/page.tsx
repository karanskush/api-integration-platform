...
// The chaptered argument that used to be the landing page. It moved here when
// the landing page became a conversion surface for paid traffic: this is the
// page for someone who has read the promise and wants to see how it is kept.
// Nothing was rewritten in the move — the chapters, their scenes and the
// Record maps below are the same ones the landing page carried.

export const metadata = {
  title: 'How it works — DocentAPI',
  description:
    'What DocentAPI does to your API, in the order it does it: lineage, field origins, live verification, and the Agent-Ready Score.',
};
...
export default function HowItWorks() {
  return (
    <div className="landing" id="top">
      ...
      <header className="wrap-l hiw-head">
        ...
        <p className="lead">
          The long version, in the order it happens: what we read, what we run, what we work out,
          and what we refuse to guess at. Every claim on this page is one the engine has to keep.
        </p>
      </header>
      ...
      <section className="chapter" id="surfaces">
        ...
        <div className="chapter-copy">
          <ChapterMark n="01" title="Surfaces" />
      ...
      <section className="chapter" id="lineage">
        ...
        <div className="chapter-copy">
          <ChapterMark n="02" title="Lineage" />
      ...
      <section className="chapter solo band" id="truth">
        <div className="chapter-copy wide">
          <ChapterMark n="03" title="The truth layer" />
      ...
      <section className="chapter" id="verify">
        ...
        <div className="chapter-copy">
          <ChapterMark n="04" title="Verification" />
      ...
      <section className="chapter solo" id="how">
        <div className="chapter-copy wide">
          <ChapterMark n="06" title="Deliverables" />
      ...
      <section className="cta" id="start">
        <div className="wrap-l">
          <h2 className="display">Now go and check yours.</h2>
          <p className="lead cta-lead">
            Sign in, paste your spec and a dev key. Everything on this page runs against your API
            in the next few minutes.
          </p>
          <a className="btn primary" href="/sign-up">
            Connect your API <span aria-hidden="true">→</span>
          </a>
          <p className="cta-note">Free while your API is public · keys never stored</p>
        </div>
      </section>
    </div>
  );
