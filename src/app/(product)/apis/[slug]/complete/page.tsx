...
import AssumptionsPanel, { type PanelAssumption } from '@/components/product/AssumptionsPanel';
import ClarificationForm, { type QuizAnswerSpec } from '@/components/product/ClarificationForm';
